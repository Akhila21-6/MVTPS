  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      const demoUsers = {
        ...
        "port_user": "port_authority",
        "insurer_user": "insurer"
      };

      if (demoUsers[username] && password === "testpass1") {
          setIsLoggedIn(true);
          setUserRole(demoUsers[username]);
          setError("");
      } else {
        ...
        <form onSubmit={handleLogin} style={loginStyles.form}>
          <div style={loginStyles.inputGroup}>
            ...
            <input
              ...
              placeholder="Enter ID (e.g., analyst_user)"
            />
          </div>
          <div style={loginStyles.inputGroup}>
